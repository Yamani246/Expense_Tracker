...
function DashBoard() {
  ...
  const fetchProfile = async () => {
    try {
      const response = await axios.get('https://expense-tracker-six-sandy-62.vercel.app/profile/', {
  ...
  const fetchExpenditure = async () => {
    try {
      const response = await axios.get('https://expense-tracker-six-sandy-62.vercel.app/expenditure/', {
        headers: { 'Authorization': `Token ${localStorage.getItem('access_token')}` }
      })
  ...
  const fetchTransaction = async () => {
    try {
      const response = await axios.get('https://expense-tracker-six-sandy-62.vercel.app/transaction/list', {
  ...
  const fetchCategoryType = () => {
    axios.get('https://expense-tracker-six-sandy-62.vercel.app/categorytype/list/', {
      headers: {
  ...
  const fetchCategories = async () => {
    try {
      const response = await axios.get('https://expense-tracker-six-sandy-62.vercel.app/category/list', {
        headers: {
          'Authorization': `Token ${localStorage.getItem('access_token')}`
        },
  ...
  const handleDelete = async (itemId, categoryType) => {
    try {
      console.log(itemId)
      const response = await axios.delete('https://expense-tracker-six-sandy-62.vercel.app/transaction/delete/', {
        headers: {
          'Authorization': `Token ${localStorage.getItem('access_token')}`
        },
        data: {
